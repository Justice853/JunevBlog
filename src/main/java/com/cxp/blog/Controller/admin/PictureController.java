...
//    跳转新增页面
    ...
    public String input(Model model) {
        model.addAttribute("picture", new PictureDo ());
        return "admin/pictures-input";
    }

//    照片新增
    @PostMapping("/pictures")
    public String post(PictureDo picture, BindingResult result, RedirectAttributes attributes){
...
//    跳转照片编辑页面
    ...
    public String editInput(@PathVariable Long id, Model model) {
        model.addAttribute("picture", pictureDoService.getPicture(id));
        return "admin/pictures-input";
    }

//    编辑相册
    @PostMapping("/pictures/{id}")
    public String editPost(PictureDo picture, RedirectAttributes attributes) {
